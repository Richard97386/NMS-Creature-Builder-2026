...
// 🎯 AUTOMATIC SAFETAIL: Bypasses the map lookup crash for newly discovered animals
export const getSafePetExtraInfo = (id: string): IPetExtraInfo => {
  return PetExtraInfo[id] || {
    initialZoom: 1.0,
    initialHeight: 0.0,
    initialCameraZ: 16,
